...
from address_search_service.gunicorn_runner import GunicornApplication
from address_search_service.settings import settings
...
def main() -> None:
    ...
    if settings.reload:
        uvicorn.run(
            "address_search_service.web.application:get_app",
